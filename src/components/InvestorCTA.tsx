    ...
    <section className="relative py-24 md:py-32 px-4 overflow-hidden">
      <div className="max-w-4xl mx-auto">
        <div className="glass-glow rounded-2xl p-10 md:p-16 text-center relative overflow-hidden">
          <div className="absolute -top-20 -left-20 w-60 h-60 rounded-full opacity-20 blur-[80px]" style={{ background: '#eab308' }} />
          <div className="absolute -bottom-20 -right-20 w-60 h-60 rounded-full opacity-20 blur-[80px]" style={{ background: '#d97706' }} />

          <div className="relative">
            <span className="inline-flex items-center gap-2 px-4 py-2 text-[10px] font-bold tracking-[0.4em] uppercase border border-[#eab308]/30 text-[#eab308] mb-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
              ...
              <a
                href="https://www.ghoulverse.com/investors?from=tradie"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center justify-center gap-2 px-8 py-4 font-bungee text-sm tracking-wider uppercase text-white transition-all hover:scale-105 border-2 border-[#d97706]/40 hover:border-[#d97706]"
