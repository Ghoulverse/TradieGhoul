...
export default function MarketStats() {
  return (
    <section className="relative py-24 md:py-32 px-4" style={{ background: 'linear-gradient(180deg, transparent, rgba(234,179,8,0.03), transparent)' }}>
      <div className="max-w-6xl mx-auto">
        ...
        <div className="glass-glow rounded-2xl p-8 md:p-12 text-center mb-12 relative overflow-hidden">
          <div className="absolute inset-0 opacity-10" style={{ background: 'radial-gradient(circle at center, #eab308, transparent 70%)' }} />
          <p className="relative text-[#94a3b8] text-xs tracking-[0.3em] uppercase mb-4">Pre-Seed Raise</p>
          <p className="relative font-mono text-5xl md:text-7xl text-white mb-2" style={{ textShadow: '0 0 40px rgba(234,179,8,0.4)' }}>
            {config.fundingAsk}
          </p>
          ...
          <div className="relative flex flex-wrap justify-center gap-4 text-xs">
            ...
            <span className="px-3 py-1 rounded-full bg-[#d97706]/10 border border-[#d97706]/30 text-[#d97706]">Equity: {config.equityOffered}</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-12">
          {config.traction.map((t, i) => {
            ...
            const statusColors = {
              ...
              'in-progress': { bg: 'rgba(217,119,6,0.1)', border: 'rgba(217,119,6,0.3)', text: '#d97706' },
              upcoming: { bg: 'rgba(234,179,8,0.1)', border: 'rgba(234,179,8,0.3)', text: '#eab308' },
            };
        ...
        <div className="glass rounded-2xl p-8 mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {config.projectedRevenue.map((rev) => (
              <div key={rev.year} className="rounded-xl p-5 border border-[#eab308]/20 bg-[#eab308]/5">
        ...
        <div className="glass rounded-2xl p-8 mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {[
              ...
              { label: 'Strong', val: '$10M', return: '$2.0M', multiple: '8x', color: '#d97706' },
        ...
        <div className="text-center">
          <a
            ...
            style={{ background: 'linear-gradient(135deg, #eab308, #d97706)', boxShadow: '0 0 30px rgba(234,179,8,0.3)' }}
          >
