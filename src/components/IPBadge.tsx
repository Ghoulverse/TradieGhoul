      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
          ...
          <div className="glass-glow rounded-2xl p-8 relative overflow-hidden">
            <div className="absolute inset-0 opacity-10" style={{ background: 'radial-gradient(circle at top right, #eab308, transparent 70%)' }} />
            <div className="relative">
              <div className="flex items-center gap-3 mb-6">
                <div className="w-12 h-12 rounded-xl bg-[#eab308]/10 border border-[#eab308]/30 flex items-center justify-center">
              ...
              <div className="flex flex-wrap gap-2">
                {config.ipClasses.map((ipClass) => (
                  <div key={ipClass} className="flex items-center gap-2 text-[#eab308] text-xs bg-[#eab308]/10 border border-[#eab308]/30 rounded-full px-3 py-1">
